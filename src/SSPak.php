...
EOM;
	...
	public function getdb_MySQLDatabase($webroot, $conf, $sspak, $filename) {
		...
		$process = $webroot->createProcess("mysqldump --set-gtid-purged=OFF --skip-opt --add-drop-table --extended-insert --create-options --quick  --set-charset --default-character-set=utf8 $usernameArg $passwordArg $hostArg $portArg $databaseArg | gzip -c");
